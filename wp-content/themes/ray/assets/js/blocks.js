...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nvar _wp$blockEditor = wp.blockEditor,\n    useBlockProps = _wp$blockEditor.useBlockProps,\n    InnerBlocks = _wp$blockEditor.InnerBlocks;\n\nvar Edit = function Edit() {\n   var MY_TEMPLATE = [['core/columns', { className: 'about-container' }, [['core/column', { className: 'about-header' }, [['core/heading', { placeholder: 'Heading' }], ['core/column', { className: 'about-content' }, [['core/paragraph', { placeholder: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed' }]]]]]]]];\n   var blockProps = useBlockProps.save({\n      className: 'pd-block pd-inline about-container'\n   });\n   return wp.element.createElement(\n      'div',\n      blockProps,\n      wp.element.createElement(InnerBlocks, {\n         template: MY_TEMPLATE,\n         templateLock: 'all' })\n   );\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Edit);\n\n//# sourceURL=webpack://ray/./blocks/about/about-template.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nvar _wp$blockEditor = wp.blockEditor,\n    useBlockProps = _wp$blockEditor.useBlockProps,\n    InnerBlocks = _wp$blockEditor.InnerBlocks;\n\n\nvar Edit = function Edit() {\n   var MY_TEMPLATE = [['core/columns', { className: 'content-container' }, [['core/column', { className: 'content-header' }, [['core/heading', { placeholder: 'Heading' }], ['core/column', { className: 'content-text' }, [['core/paragraph', { placeholder: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed' }]]]]]]]];\n   var blockProps = useBlockProps.save({\n      className: 'pd-block pd-inline content-container'\n   });\n   return wp.element.createElement(\n      'div',\n      blockProps,\n      wp.element.createElement(InnerBlocks, {\n         template: MY_TEMPLATE,\n         templateLock: 'all' })\n   );\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Edit);\n\n//# sourceURL=webpack://ray/./blocks/content/content-template.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nvar _wp$blockEditor = wp.blockEditor,\n    useBlockProps = _wp$blockEditor.useBlockProps,\n    InnerBlocks = _wp$blockEditor.InnerBlocks;\n\nvar Edit = function Edit(props) {\n  var blockProps = useBlockProps.save({\n    className: 'pd-block pd-inline courses-section'\n  });\n\n  var addRow = function addRow() {\n    var newRow = wp.blocks.createBlock('raycore/row', {});\n    wp.data.dispatch('core/block-editor').insertBlocks(newRow, 3, props.clientId);\n  };\n\n  var MY_TEMPLATE = [['core/column', { className: 'courses-header' }, [['core/heading', { level: 3, placeholder: 'Header' }]]], ['raycore/row']];\n\n  return wp.element.createElement(\n    'div',\n    blockProps,\n    wp.element.createElement(InnerBlocks, { templateLock: false, template: MY_TEMPLATE }),\n    wp.element.createElement(\n      'div',\n      { className: 'custom-add-row' },\n      wp.element.createElement(\n        'button',\n        { onClick: addRow },\n        'Add Row'\n      )\n    )\n  );\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Edit);\n\n//# sourceURL=webpack://ray/./blocks/courses/courses-template.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nvar _wp$blockEditor = wp.blockEditor,\n    useBlockProps = _wp$blockEditor.useBlockProps,\n    InnerBlocks = _wp$blockEditor.InnerBlocks;\n\n\nvar Edit = function Edit() {\n   var MY_TEMPLATE = [['core/columns', { className: 'image-content-container' }, [['core/image', { className: 'image-content-img' }], ['core/column', { className: 'image-content-content' }, [['core/column', { className: 'image-content-content-header' }, [['core/heading', { level: 1, placeholder: 'Header', className: 'h1' }], ['core/paragraph', { placeholder: 'Subtitle', className: 'subtitle' }]]], ['core/column', { className: 'subtitle' }, [['core/paragraph', { placeholder: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent eget neque nulla. Phasellus eleifend quam at felis sagittis,' }]]], ['raycore/button']]]]]];\n   var blockProps = useBlockProps.save({\n      className: 'editor-container image-content-section pd-block pd-inline'\n   });\n   return wp.element.createElement(\n      'div',\n      blockProps,\n      wp.element.createElement(InnerBlocks, {\n         template: MY_TEMPLATE,\n         templateLock: 'all' })\n   );\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Edit);\n\n//# sourceURL=webpack://ray/./blocks/image-content/image-content-template.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nvar _wp$blockEditor = wp.blockEditor,\n    useBlockProps = _wp$blockEditor.useBlockProps,\n    InnerBlocks = _wp$blockEditor.InnerBlocks;\n\n\nvar Edit = function Edit() {\n   var MY_TEMPLATE = [['core/columns', { className: 'test-content display-con display' }, [['core/column', { className: 'full-img' }, [['core/video', { className: 'displayed-video' }], ['core/paragraph', { className: 'text', placeholder: 'Loreum Ipsum' }], ['core/column', { className: 'overlay' }]]], ['core/column', { className: 'thumb-bar-video' }, [['core/column', { className: 'thumb-container' }, [['core/video', { className: 'thumb-video-item' }], ['core/paragraph', { className: 'texts', placeholder: 'Enter Video Title' }]]], ['core/column', { className: 'thumb-container' }, [['core/video', { className: 'thumb-video-item' }], ['core/paragraph', { className: 'texts', placeholder: 'Enter Video Title' }]]], ['core/column', { className: 'thumb-container' }, [['core/video', { className: 'thumb-video-item' }], ['core/paragraph', { className: 'texts', placeholder: 'Enter Video Title' }]]], ['core/column', { className: 'thumb-container' }, [['core/video', { className: 'thumb-video-item' }], ['core/paragraph', { className: 'texts', placeholder: 'Enter Video Title' }]]]]]]]];\n   var blockProps = useBlockProps.save({\n      className: 'pd-block pd-inline media-container'\n   });\n   return wp.element.createElement(\n      'div',\n      blockProps,\n      wp.element.createElement(InnerBlocks, {\n         template: MY_TEMPLATE,\n         templateLock: 'all' })\n   );\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Edit);\n\n//# sourceURL=webpack://ray/./blocks/media/media-template.js?");
